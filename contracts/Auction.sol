    ...
    UUPSUpgradeable
{
    ...
    function quoteUsd(
        ...
        return
            Math.mulDiv(
                amount,
                _priceUsd18(config),
                10 ** uint256(config.tokenDecimals)
            );
    }
    ...
    function createAuction(
        ...
        _expectedNFT = ExpectedNFT(nftContract, msg.sender, tokenId);
    ...
    function onERC721Received(
        ...
        if (
            ...
            msg.sender != expected.nftContract ||
    ...
    function placeBid(
        ...
        if (
            amount == 0 ||
            (token == address(0) ? msg.value != amount : msg.value != 0)
    ...
    function claimNFT(
        ...
        AuctionItem storage auction = _getAuction(auctionId);
        _checkRecipient(recipient);
        address claimant = auction.highestBidder == address(0)
            ? auction.seller
    ...
    function _priceUsd18(
        ...
        uint256 scale = 10 ** uint256(18 - config.feedDecimals);
